...
This extension follows the **same** API and distribution platform as the Monarch Money Retail extensions. It does not use **any** third-party API or third-party library. It has been around for over two years now and I am a moderator in the Monarch Money Reddit community forum.   Currently, there are over 2,500 active users using this extension.
