...
Use this sub‑report to view Fixed‑Income holdings, including gain/loss and extracted maturity dates. Maturity dates are parsed from the holding text and represent best‑effort estimates. If any maturities are missing or incorrect, please let me know and I’ll investigate.
...
Important: MM‑Tweaks reports are driven entirely by the holding data returned from Monarch’s API. The extension cannot invent, modify, or add holdings that the source does not provide. If it a public holding and should appear, contact Monarch support. You could always add a Manual holding to the account to shift the (BALANCE ONLY) entry to a particular holding.  
...
<img src="../documentation/images/InvestmentsV5h.png" style="width:50%; height:auto;">

- **Holding Category override (ticker or account)** — assign a category (Sector, Asset Class, your objective, Index Strategy, Bond Type, etc.) either per‑ticker or at the account level.  In my example above, I use a **sector** such as Communications.
