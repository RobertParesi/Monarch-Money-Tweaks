 ...
 * **Version 5.19 (August 16, 2026)**
    ...
    - ENHANCEMENT: Tooltips refactored for consistency and visual improvements.
 ...
 * **Version 5.10 (June 10, 2026)**
    - REGRESSION: Reports / Investments could fail with bad institution name. (null)
    
 * **Version 5.8/5.9 (June 7, 2026)**
    - ENHANCEMENT: Reports / Investments will now show all Investment accounts even when no holdings.  To turn off behavior, turn on "Skip creating Cash/MONEY MARKET & (BALANCE ONLY) entries".
  ...
  * **Version 5.7 (June 5, 2026)**
    - REGRESSION: Monarch related, Reports menu break.
 ...
 * **Version 4.41/4.42 (April 5, 2026)**
     ...
     - CHANGE: Chrome/Safari - Checkboxes updated to match Monarch’s orange/white color scheme.
     - FIX: Flex Grid resizing when grid was wider than screen.
...
* **Version 4.35 (March 7, 2026)**
     ...
     - ADD: Enhancements to the CASH/MONEY MARKET entries so they can be expanded with more information.
     - FIX: Selecting Overall Cash Report for first time may show error with too many transactions.
     - FIX: Up/Down arrow font issue on Current Price.
...
* **Version 4.32 (February 22, 2026)**
     ...
     - ADD: Added Credit Limit, Utilization and Remaining to Reports / Accounts [Credit Card Statement]
...
* **Version 4.29 (January 25, 2026)**
     ...
     - CHANGE: Prioritize Monarch fonts (Oracle vs san serif font)
...
* **Version 4.23 (December 24, 2025)**     
     ...
     - FIX: CASH/CASH MONEY MARKET value could be wrong if you had the same holding in a manual account.
...
* **Version 4.14 (November 17, 2025)**
    ...
    - CHANGE: Reports / Investments accounts marked as **Exclude account balance** will be excluded when **All Groups** is selected.  Allows you to create a manual Asset/Investment account with an Account Group (ie: Watchlist) and add manual holdings to it.
